            ...
            <div className="footer-container">
                <div className="footer-grid">
                    ...
                    <div className="footer-brand">
                        ...
                        <p className="footer-description">
                            La plateforme d'excellence pour préparer les concours des grandes écoles. Optimisez vos révisions, testez vos connaissances, et excellez.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="footer-links">
                            ...
                            <li><Link to="/quizzes" className="footer-link">Quiz Interactifs</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="footer-links">
                            ...
                            <li><Link to="/contact" className="footer-link">Nous contacter</Link></li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="footer-bottom">
                    <p className="footer-copyright">
                        &copy; {new Date().getFullYear()} QuizletCPGE. Développé avec esprit.
                    </p>
